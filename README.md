...
* `wss://lua-nostr-relay.compile-error.net` - Japanese oriented relay written in Lua by [mattn](https://github.com/mattn)
* `wss://lisp-nostr-relay.compile-error.net` - Japanese oriented relay written in Common Lisp by [mattn](https://github.com/mattn)
* `wss://ruby-nostr-relay.compile-error.net` - Japanese oriented relay written in Ruby by [mattn](https://github.com/mattn)
* `wss://nim-nostr-relay.compile-error.net` - Japanese oriented relay written in Nim by [mattn](https://github.com/mattn)
